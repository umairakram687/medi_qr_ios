...
const LetsStart = () => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <Image
          source={require("../../assets/qr-person.png")}
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.title}>
            Let’s Start Living Healthy{"\n"}And Well With Us Right Now
          </Text>

          <Text style={styles.subtitle}>
            Innovative community of Experienced Integrative health care
            practitioners who can help you
          </Text>
